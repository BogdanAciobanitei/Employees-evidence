...
INSERT INTO public.employee(
            cluster, employeedate, fullname, email, address, sex)
    VALUES ('Back', 'Jul 2, 2016', 'Bogdan B', 'BogdanB@tss-yonder.com', 'UBC3 - tss-tonder', 'Male');

INSERT INTO public.employee(
            cluster, employeedate, fullname, email, address, sex)
    VALUES ('Front', 'Jul 3, 2016', 'Bogdan C', 'BogdanC@tss-yonder.com', 'UBC3 - tss-tonder', 'Male');

INSERT INTO public.employee(
            cluster, employeedate, fullname, email, address, sex)
    VALUES ('Front', 'Jul 4, 2016', 'Bogdan D', 'BogdanD@tss-yonder.com', 'UBC3 - tss-tonder', 'Male');

INSERT INTO public.employee(
            cluster, employeedate, fullname, email, address, sex)
    VALUES ('Dev-Ops', 'Jul 5, 2016', 'Bogdan E', 'BogdanE@tss-yonder.com', 'UBC3 - tss-tonder', 'Male');

INSERT INTO public.employee(
            cluster, employeedate, fullname, email, address, sex)
    VALUES ('Dev-Ops', 'Jul 6, 2016', 'Bogdan F', 'BogdanF@tss-yonder.com', 'UBC3 - tss-tonder', 'Male');
